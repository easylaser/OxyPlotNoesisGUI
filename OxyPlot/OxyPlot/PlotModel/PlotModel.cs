...
namespace OxyPlot
{
    ...
    public partial class PlotModel : Model, IPlotModel
    {
        ...
        public PlotModel()
        {
			...
			//this.DefaultFont = "../../Assets/StreamingAssets/NoesisGui/Themes/Fonts/#Roboto-Regular";
            ...
            this.LegendMaxWidth = float.NaN;
			this.LegendMaxHeight = float.NaN;
