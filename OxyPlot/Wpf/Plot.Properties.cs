...
namespace OxyPlot.Wpf
{
    ...
    public partial class Plot
    {
        ...
        /// </summary>
        public static DependencyProperty LegendBorderProperty = DependencyProperty.Register(
        ...
        /// </summary>
        public static DependencyProperty LegendFontProperty = DependencyProperty.Register(
        ...
        /// </summary>
        public static DependencyProperty LegendFontSizeProperty = DependencyProperty.Register(
        ...
        /// </summary>
        public static DependencyProperty LegendMarginProperty = DependencyProperty.Register(
        ...
        /// </summary>
        public static DependencyProperty LegendPaddingProperty = DependencyProperty.Register(
        ...
        /// </summary>
        public static DependencyProperty LegendPositionProperty = DependencyProperty.Register(
            "LegendPosition",
        ...
        /// </summary>
        public static DependencyProperty RenderingDecoratorProperty = DependencyProperty.Register(
        ...
        /// </summary>
        public static DependencyProperty SubtitleFontProperty = DependencyProperty.Register(
        ...
        /// </summary>
        public static DependencyProperty TitleColorProperty = DependencyProperty.Register(
        ...
        /// </summary>
        public static DependencyProperty SubtitleColorProperty = DependencyProperty.Register(
        ...
        /// </summary>
        public static  DependencyProperty DefaultFontProperty = DependencyProperty.Register(
			"DefaultFont", typeof(string), typeof(Plot), new PropertyMetadata(null, AppearanceChanged));

        /// <summary>
        /// Identifies the <see cref="DefaultFontSize"/> dependency property.
        /// </summary>
        public static DependencyProperty DefaultFontSizeProperty = DependencyProperty.Register(
        ...
        /// </summary>
        public static DependencyProperty DefaultColorsProperty = DependencyProperty.Register(
            "DefaultColors",
            typeof(IList<Color>),
            typeof(Plot),
            new PropertyMetadata(
                new[]
            {
                Color.FromLinearRGB(0x4E, 0x9A, 0x06),
					Color.FromLinearRGB(0xC8, 0x8D, 0x00),
					Color.FromLinearRGB(0xCC, 0x00, 0x00),
					Color.FromLinearRGB(0x20, 0x4A, 0x87),
                    Colors.Red,
                    Colors.Orange,
                    Colors.Yellow,
                    Colors.Green,
        ...
        /// </summary>
        public static DependencyProperty AxisTierDistanceProperty = DependencyProperty.Register(
        ...
        /// </summary>
        public static DependencyProperty LegendTextColorProperty = DependencyProperty.Register(
        ...
        /// </summary>
        public static DependencyProperty LegendTitleProperty = DependencyProperty.Register(
            "LegendTitle", typeof(string), typeof(Plot), new PropertyMetadata(null, AppearanceChanged));

        /// <summary>
        /// Identifies the <see cref="LegendTextColor"/> dependency property.
        /// </summary>
        public static DependencyProperty LegendTitleColorProperty = DependencyProperty.Register(
        ...
        public static DependencyProperty PlotAreaBorderThicknessProperty =
            DependencyProperty.Register(
                "PlotAreaBorderThickness", typeof(Thickness), typeof(Plot), new PropertyMetadata(new Thickness(1.0f), AppearanceChanged));

        /// <summary>
        /// Identifies the <see cref="PlotMargins"/> dependency property.
        /// </summary>
        public static DependencyProperty PlotMarginsProperty = DependencyProperty.Register(
            "PlotMargins",
            typeof(Thickness),
            typeof(Plot),
            new PropertyMetadata(new Thickness(float.NaN), AppearanceChanged));

        /// <summary>
        /// Identifies the <see cref="PlotType"/> dependency property.
        /// </summary>
        public static DependencyProperty PlotTypeProperty = DependencyProperty.Register(
        ...
        /// </summary>
        public static DependencyProperty SubtitleProperty = DependencyProperty.Register(
        ...
        /// </summary>
        public static DependencyProperty TitleFontProperty = DependencyProperty.Register(
        ...
        /// </summary>
        public static DependencyProperty TitlePaddingProperty = DependencyProperty.Register(
        ...
        /// </summary>
        public static DependencyProperty TitleToolTipProperty = DependencyProperty.Register(
        ...
        /// </summary>
        public static DependencyProperty InvalidateFlagProperty = DependencyProperty.Register(
            "InvalidateFlag",
            typeof(int),
            typeof(Plot),
        ...
        /// The series.
        /// </summary>
		private ObservableCollection<OxyPlot.Wpf.Series> series;
        ...
        public Collection<OxyPlot.Wpf.Series> Series
        {
            get
            {
                return this.series;
