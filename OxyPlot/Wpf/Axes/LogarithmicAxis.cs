...
namespace OxyPlot.Wpf
{
    ...
    public class LogarithmicAxis : Axis
    {
        ...
        public static DependencyProperty BaseProperty = DependencyProperty.Register(
        ...
        /// </summary>
        public static DependencyProperty PowerPaddingProperty = DependencyProperty.Register(
