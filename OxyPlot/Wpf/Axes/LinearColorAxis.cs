...
namespace OxyPlot.Wpf
{
    ...
    public class LinearColorAxis : Axis
    {
        ...
        /// </summary>
        public static DependencyProperty GradientStopsProperty = DependencyProperty.Register(
            "GradientStops",
        ...
        /// </summary>
        public static DependencyProperty PaletteSizeProperty = DependencyProperty.Register(
            "PaletteSize",
            typeof(int),
            typeof(LinearColorAxis),
...
//                                   : new OxyPalette();
        ...
        private static OxyPalette Interpolate(List<GradientStop> stops, int paletteSize)
        {
            ...
            var step = (float)stops.Count / paletteSize;
