...
namespace OxyPlot.Wpf
{
    ...
    public class ArrowAnnotation : TextualAnnotation
    {
        ...
        /// </summary>
        public static DependencyProperty ArrowDirectionProperty = DependencyProperty.Register(
            "ArrowDirection", typeof(ScreenVector), typeof(ArrowAnnotation), new PropertyMetadata(null, DataChanged));
        ...
        public static DependencyProperty EndPointProperty = DependencyProperty.Register(
			"EndPoint", typeof(DataPoint), typeof(ArrowAnnotation), new PropertyMetadata(null, DataChanged));

        /// <summary>
        /// Identifies the <see cref="HeadLength"/> dependency property.
        /// </summary>
        public static DependencyProperty HeadLengthProperty = DependencyProperty.Register(
        ...
        /// </summary>
        public static DependencyProperty HeadWidthProperty = DependencyProperty.Register(
        ...
        public static DependencyProperty StartPointProperty = DependencyProperty.Register(
			"StartPoint", typeof(DataPoint), typeof(ArrowAnnotation), new PropertyMetadata(null, DataChanged));
        ...
        /// </summary>
        public static DependencyProperty VeenessProperty = DependencyProperty.Register(
