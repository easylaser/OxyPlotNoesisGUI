...
namespace OxyPlot.Wpf
{
    ...
    public abstract class Annotation : FrameworkElement
    {
        ...
        /// </summary>
        public static DependencyProperty XAxisKeyProperty = DependencyProperty.Register(
            "XAxisKey",
            typeof(string),
            typeof(Annotation),
        ...
        /// </summary>
        public static DependencyProperty YAxisKeyProperty = DependencyProperty.Register(
            "YAxisKey",
            typeof(string),
            typeof(Annotation),
            new PropertyMetadata(null, AppearanceChanged));
