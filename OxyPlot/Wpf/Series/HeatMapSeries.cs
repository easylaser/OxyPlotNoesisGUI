...
namespace OxyPlot.Wpf
{
    ...
    public class HeatMapSeries : XYAxisSeries
    {
        ...
        /// </summary>
        public static DependencyProperty X0Property = DependencyProperty.Register(
            "X0",
            typeof(double),
            typeof(HeatMapSeries),
        ...
        /// </summary>
        public static DependencyProperty X1Property = DependencyProperty.Register(
            "X1",
            typeof(double),
            typeof(HeatMapSeries),
            new PropertyMetadata(default(double), AppearanceChanged));
        ...
        /// </summary>
        public static DependencyProperty Y0Property = DependencyProperty.Register(
            "Y0",
            typeof(double),
            typeof(HeatMapSeries),
            new PropertyMetadata(default(double), AppearanceChanged));
        ...
        /// </summary>
        public static DependencyProperty Y1Property = DependencyProperty.Register(
            "Y1",
            typeof(double),
            typeof(HeatMapSeries),
            new PropertyMetadata(default(double), AppearanceChanged));
        ...
        /// </summary>
        public static DependencyProperty ColorAxisKeyProperty = DependencyProperty.Register(
            "ColorAxisKey",
            typeof(string),
            typeof(HeatMapSeries),
        ...
        /// </summary>
        public static DependencyProperty LowColorProperty = DependencyProperty.Register(
            "LowColor",
            typeof(Color),
            typeof(HeatMapSeries),
        ...
        /// </summary>
        public static DependencyProperty HighColorProperty = DependencyProperty.Register(
            "HighColor",
            typeof(Color),
            typeof(HeatMapSeries),
            new PropertyMetadata(default(Color)));
