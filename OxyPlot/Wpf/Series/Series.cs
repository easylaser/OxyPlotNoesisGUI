...
namespace OxyPlot.Wpf
{
    ...
    public abstract class Series : ItemsControl
    {
        ...
        /// </summary>
        public static DependencyProperty RenderInLegendProperty = DependencyProperty.Register(
        ...
        /// </summary>
        public static DependencyProperty TrackerKeyProperty = DependencyProperty.Register(
...
//                CollectionChangedEventManager.AddListener(collection, this.eventListener);
        ...
        private class EventListener //: IWeakEventListener
        {
            ...
            /// </summary>
            private EventHandler<NotifyCollectionChangedEventArgs> onCollectionChanged;
