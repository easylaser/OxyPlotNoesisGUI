...
namespace OxyPlot.Wpf
{
    ...
    public static class ConverterExtensions
    {
        ...
        {
			return new Thickness((float)c.Left, (float)c.Top, (float)c.Right, (float)c.Bottom);
        }
...
//
        ...
        public static HorizontalAlignment ToHorizontalAlignment(this Noesis.HorizontalAlignment alignment)
        {
            switch (alignment)
            {
				case Noesis.HorizontalAlignment.Center:
					return HorizontalAlignment.Center;
				case Noesis.HorizontalAlignment.Right:
		...
		/// <param name="alignment">The alignment.</param>
		/// <returns>A HorizontalAlignment.</returns>
		public static HorizontalAlignment ToHorizontalAlignment(this HorizontalAlignment alignment)
		{
			switch (alignment)
			{
        ...
        public static VerticalAlignment ToVerticalAlignment(this Noesis.VerticalAlignment alignment)
        {
            switch (alignment)
            {
				case Noesis.VerticalAlignment.Center:
	            	return VerticalAlignment.Middle;
				case Noesis.VerticalAlignment.Top:
		...
		/// <param name="alignment">The alignment.</param>
		/// <returns>A VerticalAlignment.</returns>
		public static VerticalAlignment ToVerticalAlignment(this VerticalAlignment alignment)
		{
			switch (alignment)
			{
...
//        }
        ...
        public static OxyTouchEventArgs ToTouchEventArgs(this ManipulationStartedEventArgs e, UIElement relativeTo)
        {
            ...
            {
				Position = new ScreenPoint(pos.X, pos.Y),
            };
        }
...
//        }
		...
		// @TODO: Move this to utilities class or make into extension!
