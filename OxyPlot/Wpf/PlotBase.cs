...
namespace OxyPlot.Wpf
{
    ...
    /// Represents a control that displays a <see cref="PlotModel" />.
    /// </summary>
    public abstract partial class PlotBase : UserControl, IPlotView
    {
        /// <summary>
        ...
        /// </summary>
        private ObservableCollection<TrackerDefinition> trackerDefinitions;
...
//            }
        ...
        public void OnApplyTemplate()
        {
           // base.OnApplyTemplate();
			...
			if(this.canvas != null)
				this.grid.Children.Remove(this.canvas);
...
//            }
        ...
        {
			this.zoomControl.Width = (float)r.Width;
			this.zoomControl.Height = (float)r.Height;
			Canvas.SetLeft(this.zoomControl, (float)r.Left);
			Canvas.SetTop(this.zoomControl, (float)r.Top);
...
//        }
        ...
        protected bool IsVisibleToUser()
        {
            ...
            if (container != null)
            {
				var visible = true;//this.IsUserVisible(this, container);
                if (!visible)
                {
                    return false;
                }
...
//        }
        ...
        {
			var container = VisualTreeHelper.GetParent((Visual)obj) as FrameworkElement;
